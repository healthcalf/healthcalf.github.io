...
class CompiledApp {
  ...
  async instantiate(additionalImports,
    ...
    const dart2wasm = {
      ...
      _1330: (x0,x1,x2) => x0.setRequestHeader(x1,x2),
      ...
      _1333: x0 => x0.send(),
      _1334: () => new XMLHttpRequest(),
      _1338: (x0,x1) => x0.createElement(x1),
      _1339: x0 => ({type: x0}),
      _1340: (x0,x1) => new Blob(x0,x1),
      _1341: x0 => globalThis.URL.createObjectURL(x0),
      _1352: x0 => x0.click(),
      _1356: x0 => x0.remove(),
      _1365: Date.now,
      ...
      _1731: () => globalThis.document,
      _1733: () => globalThis.console,
      _1738: (x0,x1) => { x0.height = x1 },
      _1740: (x0,x1) => { x0.width = x1 },
      _1742: (x0,x1) => { x0.pointerEvents = x1 },
      _1751: x0 => x0.style,
      _1754: x0 => x0.src,
      _1755: (x0,x1) => { x0.src = x1 },
      _1756: x0 => x0.naturalWidth,
      _1757: x0 => x0.naturalHeight,
      _1772: (x0,x1) => x0.error(x1),
      _1777: x0 => x0.status,
      _1778: (x0,x1) => { x0.responseType = x1 },
      _1780: x0 => x0.response,
      _1908: x0 => x0.style,
      _2267: (x0,x1) => { x0.download = x1 },
      _2292: (x0,x1) => { x0.href = x1 },
      _6290: () => globalThis.document,
      _6372: x0 => x0.body,
      _6708: (x0,x1) => { x0.id = x1 },
      _6735: x0 => x0.children,
      _11161: (x0,x1) => { x0.display = x1 },
